...
{% include cart-philosophies/cart-philosophies-block.markdown box-type="table cart-philosophies-guides" value="cart-philosophies/codes-examples/00-block.markdown" %}
